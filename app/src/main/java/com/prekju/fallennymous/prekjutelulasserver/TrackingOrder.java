...
//                Toast.makeText(this, "Couldn't get the location", Toast.LENGTH_SHORT).show();
                Log.d("DEBUG", "tidak dapat menemukan lokasi");
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    MarkerOptions markerOptions = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Pesanan " + Common.currentRequest.getPhone())
    ...
    private boolean checkPlayService() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode))
                ...
                Toast.makeText(this, "perangkat tidak didukung", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
